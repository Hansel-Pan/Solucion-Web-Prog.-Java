...
Desarrollar un sistema web tipo POS para TechStore Santander utilizando **Java Spring Boot**, **Thymeleaf** y **JPA/Hibernate**, con el fin de optimizar el control de inventario, automatizar el registro de ventas y facilitar la gestión de facturación electrónica.

### Objetivos Funcionales

- Implementar un módulo de **gestión de inventario en tiempo real** que permita controlar entradas, salidas y stock disponible de productos.
- Desarrollar un módulo de **ventas** que registre automáticamente cada transacción realizada en el punto de venta.
- Crear un módulo de **gestión de clientes y facturación** que permita almacenar el historial de compras y generar comprobantes de venta.

### Objetivos Técnicos

- Construir una aplicación web bajo **arquitectura MVC** utilizando Spring Boot, Thymeleaf y JPA/Hibernate para garantizar mantenibilidad y escalabilidad.
- Diseñar una **base de datos relacional** que permita almacenar información de productos, ventas, usuarios y clientes de forma segura y organizada.
